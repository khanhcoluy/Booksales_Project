...
class CategoryProduct extends Controller
{
    ...
    public function add_category_product(){
        $this->AuthLogin();
        $all_category_product = DB::table('tbl_category_product')->where('category_parent',0)->orderBy('category_id','desc')->get();
    ...
    public function edit_category_product($category_product_id){
        ...
        $all_category_product = DB::table('tbl_category_product')->where('category_parent',0)->orderBy('category_id','desc')->get();
        $manager_category_product  = view('admin.edit_category_product')->with('edit_category_product',$edit_category_product)->with('all_category_product',$all_category_product);
