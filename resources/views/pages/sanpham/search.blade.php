...
h3.account-header {
    ...
    <section class="breadcrumbbar">
        <div class="container">
            <ol class="breadcrumb mb-0 p-0 bg-transparent">
                ...
                <li class="breadcrumb-item active"><a href="">Tìm kiếm sách</a></li>
            </ol>
        </div>
    </section>
   ...
   {{--  <section class="banner">
    ...
    <section class="page-content my-3">
        <div class="container">
            <div>
                <h4 class="header text-uppercase">Từ khóa tìm kiếm : {{$keywords}}</h4>
            </div>
    ...
    <section class="content my-4">
        <div class="container">
            <div class="noidung bg-white" style=" width: 100%;">
                ...
                <div class="items">
                    <div class="row">
                         @foreach($search_product as $key => $cate)
