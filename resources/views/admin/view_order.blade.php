        ...
        <tbody>
          ...
          <tr>
            ...
            <td>{{$shipping->shipping_address}}</td>
             ...
             <td>@if($shipping->shipping_method==2) Giao hàng nhanh @else Giao hàng tiêu chuẩn @endif</td>
             <td>@if($shipping->shipping_payment==2) Chuyển khoản @else Tiền mặt @endif</td>
